		...
		<div class="panel panel-info">
			...
			<div class="panel-footer" style="height: 51px;">
				<span class="pull-right">
					<a href="{{ url('pemuda/'. $gereja->id .'/edit') }}" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
